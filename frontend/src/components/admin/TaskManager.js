...
const TaskManager = ({ token, clients = [] }) => {
  ...
  return (
    <div className="space-y-6" data-testid="task-manager">
        ...
        <div className="space-y-4">
          {teamUsers.length === 0 ? (
            <div className="text-center py-12 text-white/40">
              ...
              <p className="text-sm">Ajoutez des collaborateurs pour leur assigner des tâches</p>
            </div>
          ) : (
            teamUsers.map(user => (
              <div
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => setEditingTeamUser(user)}
                      className="p-2 hover:bg-white/10 rounded-lg text-white/60 hover:text-white"
                      data-testid={`edit-team-user-${user.id}`}
                    >
                      <Edit2 className="w-4 h-4" />
                    </button>
                    <button
                      ...
                      className="p-2 hover:bg-red-500/20 rounded-lg text-white/60 hover:text-red-400"
                      data-testid={`delete-team-user-${user.id}`}
                    >
                      <Trash2 className="w-4 h-4" />
                    </button>
                  </div>
              ...
              {newTask.client_id && (
                <div className="border-t border-white/10 pt-4">
                  <label className="flex items-center gap-2 cursor-pointer mb-3">
                    <input
                      type="checkbox"
                      checked={newTask.client_visible}
                      onChange={(e) => setNewTask({ ...newTask, client_visible: e.target.checked })}
                      className="rounded border-white/20"
                    />
      ...
      {showAddTeamUser && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#1a1a1a] rounded-xl w-full max-w-md" data-testid="add-team-user-modal">
            <div className="border-b border-white/10 p-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-white">Nouveau collaborateur</h2>
              <button onClick={() => setShowAddTeamUser(false)} className="text-white/60 hover:text-white">
                <X className="w-6 h-6" />
              </button>
            </div>
            
            <form onSubmit={handleCreateTeamUser} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  data-testid="team-user-name-input"
                />
              </div>
              ...
              <div>
                <label className="block text-white/60 text-sm mb-1">Rôle *</label>
                <select
                ...
                >
                  ...
                  <option value="editor">Éditeur - Peut voir et modifier toutes les tâches</option>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="button"
                  onClick={() => setShowAddTeamUser(false)}
                  className="flex-1 px-4 py-2 border border-white/20 rounded-lg text-white hover:bg-white/5"
                >
                  Annuler
                </button>
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-primary text-black rounded-lg font-medium hover:bg-primary/80"
                  data-testid="create-team-user-btn"
                >
                  Créer
                </button>
              </div>
      ...
      {editingTeamUser && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#1a1a1a] rounded-xl w-full max-w-md" data-testid="edit-team-user-modal">
            <div className="border-b border-white/10 p-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-white">Modifier le collaborateur</h2>
              <button onClick={() => setEditingTeamUser(null)} className="text-white/60 hover:text-white">
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={editingTeamUser.is_active}
                    onChange={(e) => setEditingTeamUser({ ...editingTeamUser, is_active: e.target.checked })}
                    className="rounded border-white/20"
                  />
                  <span className="text-white">Compte actif</span>
                </label>
              </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  onClick={() => handleUpdateTeamUser(editingTeamUser.id, {
                    name: editingTeamUser.name,
                    role: editingTeamUser.role,
                    is_active: editingTeamUser.is_active
                  })}
                  className="flex-1 px-4 py-2 bg-primary text-black rounded-lg font-medium hover:bg-primary/80"
                  data-testid="update-team-user-btn"
                >
                  Enregistrer
                </button>
              </div>
